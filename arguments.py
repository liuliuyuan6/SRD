...
def add_model_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--generate-data-dir', type=str, help='Path to generated data')
    parser.add_argument('--truth-data-dir', type=str, help='Path to ground truth data')
    parser.add_argument('--save-dir', type=str, help='Directory to save processed results')
    parser.add_argument('--model-name', type=str, help='Model name used in the data key')
    return parser
...
def add_distillm_args(parser: argparse.ArgumentParser):
    ...
    #tem
    group.add_argument("--temperature-kld", type=float, default=1.0)
    return parser
