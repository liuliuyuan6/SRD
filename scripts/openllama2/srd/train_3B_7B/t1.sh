...
PEFT_CKPT_NAME=${5-"pocl_rkl/t0/356"}
...
# data
DATA_DIR="${BASE_PATH}/processed_data/dolly/full/openllama2/train1/"
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/openllama2/train/pocl_rkl/t1"
# seed
SEED=10
...
OPTS+=" --do-valid"
OPTS+=" --eval-gen"
OPTS+=" --save-interval 178"
OPTS+=" --eval-interval 178"
