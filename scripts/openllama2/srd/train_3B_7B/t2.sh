...
PEFT_CKPT_NAME=${5-"pocl_rkl/t1/712"}
...
# data
DATA_DIR="${BASE_PATH}/processed_data/dolly/full/openllama2/train2/"
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/openllama2/train/pocl_rkl/t2"
# seed
SEED=10
...
OPTS+=" --do-valid"
OPTS+=" --eval-gen"
OPTS+=" --save-interval 267"
OPTS+=" --eval-interval 267"
