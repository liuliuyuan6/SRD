...
CKPT_NAME="open_llama_7b_v2"
#CKPT="${BASE_PATH}/checkpoints/${CKPT_NAME}/"
CKPT="${BASE_PATH}/results/openllama2/train/sft/sft_7B/e20-bs4-lr0.0005-G2-N4-NN1-lora-16-64-0.1/714/"
...
OPTS+=" --do-valid"
OPTS+=" --eval-gen"
OPTS+=" --save-interval 357"
OPTS+=" --eval-interval 357"
