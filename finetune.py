...
from SRD import tem_forward_kl, forward_kl, tem_reverse_kl,reverse_kl, tem_js_distance, js_distance, tem_tv_distance, tv_distance
from SRD import tem_skewed_forward_kl,skewed_forward_kl, skewed_reverse_kl, tem_skewed_reverse_kl,pro_skewed_forward_kl_2,pro_skewed_forward_kl_1
from SRD import SampleGenerator, ReplayBuffer
...
def get_distil_loss(args, tokenizer, model, teacher_model, model_batch, no_model_batch, logits,temperature_kld):
    ...
    if args.model_parallel:
        ...
        if "tfkl" in args.type:
            ...
            distil_loss = tem_tv_distance(logits, teacher_logits, no_model_batch,temperature_kld)
